...
const content = {
  en: {
    ...
    whatCompare: "The Queed Meter connects to your home's electricity supply and tells you exactly how much power you're using and what is using it. Kahrabai, Queed's AI assistant, learns your home's and improve energy management.",
